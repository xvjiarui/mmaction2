...
model = dict(
    ...
    img_head=dict(
        ...
        projection_mid_channels=embed_dim,
        projection_out_channels=embed_dim,
        num_predictor_fcs=2,
        predictor_mid_channels=embed_dim // 4,
        predictor_out_channels=embed_dim,
        with_norm=True,
        loss_feat=dict(type='CosineSimLoss', negative=False),
        spatial_type='avg'))
# model training and testing settings
train_cfg = dict(multi_pair=True, pair_scale=True)
test_cfg = dict(
    precede_frames=20,
    topk=10,
    temperature=0.2,
