...
model = dict(
    ...
    backbone=dict(
        ...
        'pretrained/ssb_r18_nc_sgd_cos_50e_r2_1x8x2_k400-backbone.pth',  # noqa: E501
        depth=18,
        out_indices=(3, ),
        # strides=(1, 2, 1, 1),
    ...
    # cls_head=None,
    # patch_head=None,
    att_plugin=dict(type='PixelPro', in_channels=512, use_residual=True),
    img_head=dict(
        type='SimSiamHead',
        in_channels=512,
...
train_cfg = dict(intra_video=False, att_indices=(3, ), att_src2dst=False)
test_cfg = dict(
    precede_frames=20,
    topk=10,
    temperature=0.2,
...
optimizer = dict(type='SGD', lr=0.05 * 0.1, momentum=0.9, weight_decay=0.0001)
