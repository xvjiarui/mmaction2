...
CLASSES = [
    ...
    'coat', 'socks', 'pants', 'gloves', 'scarf', 'skirt', 'torso-skin', 'face',
    'right-arm', 'left-arm', 'right-leg', 'left-leg', 'right-shoe', 'left-shoe'
]
...
parser.add_argument(
    '-g', '--gt_dir', type=str, default=GT_DIR, help='ground truth path')
parser.add_argument(
    '-p', '--pre_dir', type=str, default=PRE_DIR, help='prediction path')
